...
/*  Created On : 15-nov.-2023 17:06:06 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
CREATE SEQUENCE car_id_car_seq INCREMENT 1 START 0
;

CREATE SEQUENCE car_situation_id_cs_seq INCREMENT 1 START 0
;

CREATE SEQUENCE change_type_id_aut_change_type_seq INCREMENT 1 START 0
;

CREATE SEQUENCE date_id_aut_date_seq INCREMENT 1 START 0
;

CREATE SEQUENCE driver_id_driver_seq INCREMENT 1 START 0
;

CREATE SEQUENCE driver_situation_id_ds_seq INCREMENT 1 START 0
;

CREATE SEQUENCE group_tour_id_group_seq INCREMENT 1 START 0
;

CREATE SEQUENCE mod_change_id_mod_change_seq INCREMENT 1 START 0
;

CREATE SEQUENCE modification_id_mod_seq INCREMENT 1 START 0
;

CREATE SEQUENCE programming_type_id_aut_prog_type_seq INCREMENT 1 START 0
;

CREATE SEQUENCE route_id_route_seq INCREMENT 1 START 0
;

CREATE SEQUENCE solicitude_id_solicitude_seq INCREMENT 1 START 0
;

CREATE SEQUENCE type_car_situation_id_aut_type_cs_seq INCREMENT 1 START 0
;

CREATE SEQUENCE type_driver_situation_id_aut_type_ds_seq INCREMENT 1 START 0
;
